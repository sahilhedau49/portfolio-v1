    ...
    <>
      <div id="projects" className="flex min-h-[30vh] my-20 py-10">
        <div className="w-[70%] m-auto">
          ...
          <button className="block mx-auto text-center px-8 py-3 rounded-full text-slate-50 border-2 border-slate-950 duration-300 bg-slate-950 hover:text-slate-950 hover:bg-slate-50 hover:-translate-y-1">
            View More
          </button>
        </div>
      </div>
